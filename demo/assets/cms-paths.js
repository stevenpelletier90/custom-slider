...
// 256 pairs: 248 byte-proved, 8 name-matched (the chrome-*.webp group above).
// Harvested 2026-09-04 by re-running the script; merged additively since.
// Last proved in full 2026-09-15 - every pair fetched from acurademo1, a domain
// unrelated to any of them, and hashed against the local file.
...
globalThis.CARGO = Object.assign(globalThis.CARGO || {}, {
  CMS: {
    ...
    // Cadillac, Ford, Kia and Toyota taken up to the full rosters their live
    // bars draw (2026-09-15). Cadillac and Ford move off ChromeData onto the
    // bar's own folder, which is what those bars actually serve and the only
    // route that reaches every model; Kia keeps the mix its bar uses.
