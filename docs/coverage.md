...
**49 codes in scope. 7 built.** The other 42 are the work.

| Status                          |  N  | What it means                                                                                         |
| ------------------------------- | :-: | ----------------------------------------------------------------------------------------------------- |
| **Replacement built**           |  7  | A measured preset in `brands.js` draws this code's bar. Ready to hand a designer.                     |
| **Pattern ready, not measured** | 27  | The builder already has the right pattern; nobody has measured this OEM's version of it yet.          |
...
| Kia        | Tabs v2                               | `kia-model-bar-tabbed`                              | kiademo1                       | `tabs`      | Replacement built           | `brands.js` kia, measured 2026-09-15                                                                                                                       |
