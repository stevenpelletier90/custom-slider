...
**49 codes in scope. 4 built.** The other 45 are the work.

| Status                          |  N  | What it means                                                                                         |
| ------------------------------- | :-: | ----------------------------------------------------------------------------------------------------- |
| **Replacement built**           |  4  | A measured preset in `brands.js` draws this code's bar. Ready to hand a designer.                     |
| **Pattern ready, not measured** | 30  | The builder already has the right pattern; nobody has measured this OEM's version of it yet.          |
...
| ---------- | ------------------------------------- | --------------------------------------------------- | ------------------------------ | ----------- | --------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cadillac   | Tabs                                  | `cadillac-model-bar`                                | cadillacdemo1                  | `tabs`      | Replacement built           | `brands.js` cadillac, measured 2026-09-14                                                                                                                  |
| Chevrolet  | Tabs                                  | `chevrolet-model-bar`                               | chevroletdemo1                 | `tabs`      | Replacement built           | `brands.js` chevrolet, measured 2026-09-14                                                                                                                 |
| Ford       | Slick Tabbed                          | `ford-model-bar-slick-tabbed-panels`                | forddemo1                      | `tabs`      | Replacement built           | `brands.js` ford, measured 2026-09-14                                                                                                                      |
| Toyota     | Tabs v2                               | `toyota-modelbar-slick-tabbed-v2`                   | toyotademo4                    | `tabs`      | Replacement built           | `brands.js` toyota, measured from toyotademo1 2026-09-10, which draws this same bar                                                                        |
...
| GMC        | Tabs                                  | `gmc-model-bar`                                     | gmcdemo1                       | `tabs`      | Pattern ready, not measured | 1 slick bar, 6 slides, 5@768:3,460:2 — and NO tab row, though the article calls it Tabs                                                                    |
| Honda      | Slick                                 | `honda-model-bar-slick`                             | hondademo4                     | `modelbar`  | Pattern ready, not measured | 1 slick bar, 10 slides, 5@768:3,460:2                                                                                                                      |
...
| Kia        | Tabs                                  | `kia-model-bar`                                     | kiademo2                       | `tabs`      | Pattern ready, not measured | 3 slick bars behind a tab row, 5@768:3,460:2                                                                                                               |
| Kia        | Tabs v2                               | `kia-model-bar-tabbed`                              | kiademo1                       | `tabs`      | Pattern ready, not measured | 3 slick bars, 3@768:1, centre-mode                                                                                                                         |
...
| Subaru     | Slick Tabs                            | `subaru-model-bar-slick`                            | subarudemo2                    | `tabs`      | Pattern ready, not measured | 6 slick instances, 5@1199:4,991:3,539:2                                                                                                                    |
...
| Toyota     | Slick                                 | `toyota-modelbar-slick`                             | toyotademo1                    | `modelbar`  | Article looks wrong         | `toyotademo1` draws the five-tab bar — same tabs, same 6/8/2/7/13 slide counts, same ladder as `toyotademo4` (Tabs v2). Nothing on it is a plain slick bar |
