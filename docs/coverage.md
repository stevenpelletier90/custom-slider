...
| **Pattern ready, not measured**    | 26  | The builder already has the right pattern; nobody has measured this OEM's version of it yet.          |
...
| Kia        | Tabs                                  | `kia-model-bar`                                     | kiademo2                       | `tabs`      | Replacement built              | `brands.js` kia, measured 2026-09-15 from kiademo2, the equal-card bar                                                                                     |
